            ...
            for (var key in item) {
                if (String(key)[0] != '$') {
                    if (typeof item[key] === 'object') {
                        if ( (item[key].title).toUpperCase().indexOf( historyCtrl.search.toUpperCase() ) != -1 ) count++;
                    } else if (typeof item[key] === 'number') {
                                if (String(item[key]).indexOf(historyCtrl.search) != -1) count++;
                            }
                            else if ( (item[key]).toUpperCase().indexOf( historyCtrl.search.toUpperCase() ) != -1 ) count++;
                }
            }
